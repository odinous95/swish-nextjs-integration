...
// NO LONGER NEEDED: import fs from "fs";
// NO LONGER NEEDED: import path from "path";
...
const testConfig: SwishConfig = {
  ...
  qrHost: "https://mpc.getswish.net/qrg-swish",
  // *** MODIFIED LINES HERE ***
  cert: Buffer.from(process.env.SWISH_CERT_TEST_BASE64!, "base64"),
  key: Buffer.from(process.env.SWISH_KEY_TEST_BASE64!, "base64"),
